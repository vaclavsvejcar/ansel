...
create table a_user (id int8 generated by default as identity, email varchar(255), first_name varchar(50), last_name varchar(50), password varchar(255), primary key (id));
